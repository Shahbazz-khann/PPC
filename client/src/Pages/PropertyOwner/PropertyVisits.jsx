    ...
    <div style={S.page}>
      ...
      <div style={S.filterBar}>
        ...
        <div style={S.filterGroup}>
          <span style={S.filterLabel}>Visit Status</span>
        ...
        {filtered.length === 0 ? (
          ...
          <>
            <table style={S.table}>
              <thead>
                <tr style={S.thead}>
                  {['Property', 'Visit ID', 'Type', 'City', 'Customer', 'Visit Date', 'Visit Time', 'Status', 'Action'].map((h) => (
...
export default OwnerPropertyVisits;
