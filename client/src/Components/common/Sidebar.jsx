...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-[#032B1D] text-white flex flex-col p-2 select-none">
      {/* Logo Section */}
      <div className="px-2  flex items-center justify-center">
        <Link to="/" className="block">
          <img src={LogoS} alt="Property Care Pakistan" className="h-30 w-auto object-contain" />
        </Link>
      </div>
